...
use App\Repository\Oriwood\FProtectioncialRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'F_PROTECTIONCIAL')]
#[ORM\UniqueConstraint(name: 'IPROTCIAL_USER', columns: ['cbCIPROT_User'])]
#[ORM\UniqueConstraint(name: 'IPROTCIAL_NO', columns: ['PROT_No'])]
#[ORM\Index(name: 'IPROTCIAL_PROFIL', columns: ['PROT_UserProfil'])]
#[ORM\Index(name: 'FKIA_F_PROTECTIONCIAL_PROT_UserProfil', columns: ['cbPROT_UserProfil'])]
#[ORM\Entity(repositoryClass: FProtectioncialRepository::class)]
class FProtectioncial
{
