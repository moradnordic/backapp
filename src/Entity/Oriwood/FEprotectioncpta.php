...
use App\Repository\Oriwood\FEprotectioncptaRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'F_EPROTECTIONCPTA')]
#[ORM\UniqueConstraint(name: 'IEPROTCPTA_CMD', columns: ['EPROT_Cmd'])]
#[ORM\Index(name: 'FKIA_F_EPROTECTIONCPTA_PROT_No', columns: ['PROT_No'])]
#[ORM\Entity(repositoryClass: FEprotectioncptaRepository::class)]
class FEprotectioncpta
{
