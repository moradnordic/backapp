...
use App\Repository\Oriwood\PSecuritystrategycialRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'P_SECURITYSTRATEGYCIAL')]
#[ORM\Entity(repositoryClass: PSecuritystrategycialRepository::class)]
class PSecuritystrategycial
{
