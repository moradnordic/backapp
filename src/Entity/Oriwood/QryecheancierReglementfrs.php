...
use App\Repository\Oriwood\QryecheancierReglementfrsRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'qryEcheancier_ReglementFrs')]
#[ORM\Entity(repositoryClass: QryecheancierReglementfrsRepository::class)]
class QryecheancierReglementfrs
{
    #[ORM\Column(name: "N°")]
    private ?int $n° = null;
