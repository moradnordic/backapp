...
use App\Repository\Oriwood\PInterneRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'P_INTERNE')]
#[ORM\Entity(repositoryClass: PInterneRepository::class)]
class PInterne
{
    ...
    #[ORM\Column(name: "D_Intitule", length: 65, nullable: true)]
    private ?string $dIntitule = null;

    #[ORM\Column(name: "D_MvtStock", type: Types::SMALLINT, nullable: true)]
    private ?int $dMvtstock = null;
    ...
    public function getDMvtstock(): ?int
    {
        return $this->dMvtstock;
    }

    public function setDMvtstock(?int $dMvtstock): static
    {
        $this->dMvtstock = $dMvtstock;
