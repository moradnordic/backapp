...
use App\Repository\Oriwood\FAboligneRepository;
...
class FAboligne
{
    ...
    #[ORM\Column(name: "QteUniteAchat", type: Types::DECIMAL, precision: 24, scale: 6, nullable: true)]
    private ?string $qteuniteachat = null;

    #[ORM\Column(name: "ligneCounter", type: Types::DECIMAL, precision: 24, scale: 6, nullable: true)]
    private ?string $lignecounter = null;
    ...
    public function getQteuniteachat(): ?string
    {
        return $this->qteuniteachat;
    }

    public function setQteuniteachat(?string $qteuniteachat): static
    {
        $this->qteuniteachat = $qteuniteachat;

        return $this;
    }

    public function getLignecounter(): ?string
    {
        return $this->lignecounter;
    }

    public function setLignecounter(?string $lignecounter): static
    {
        $this->lignecounter = $lignecounter;
