...
use App\Repository\Oriwood\TbsUsersRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'tbS_Users')]
#[ORM\Entity(repositoryClass: TbsUsersRepository::class)]
class TbsUsers
{
    #[ORM\Column(name: "N°")]
    private ?int $n° = null;
    ...
    #[ORM\Column(name: "CanAccessCompany")]
    private ?bool $canaccesscompany = null;
    ...
    public function getCanaccesscompany(): ?bool
    {
        return $this->canaccesscompany;
    }

    public function setCanaccesscompany(bool $canaccesscompany): static
    {
