...
use App\Repository\Oriwood\FArticleRepository;
...
class FArticle
{
    ...
    #[ORM\Column(name: "largeur", length: 21, nullable: true)]
    private ?string $largeur = null;

    #[ORM\Column(name: "longeur", length: 21, nullable: true)]
    private ?string $longeur = null;

    #[ORM\Column(name: "epaisseur", length: 21, nullable: true)]
    private ?string $epaisseur = null;

    #[ORM\Column(name: "couleur", length: 21, nullable: true)]
    ...
    #[ORM\Column(name: "NATURE", length: 21, nullable: true)]
    private ?string $nature = null;

    #[ORM\Column(name: "SURFACE", length: 21, nullable: true)]
