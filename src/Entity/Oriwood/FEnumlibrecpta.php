...
use App\Repository\Oriwood\FEnumlibrecptaRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'F_ENUMLIBRECPTA')]
#[ORM\UniqueConstraint(name: 'IELCPTA_INT', columns: ['cbEL_Intitule'])]
#[ORM\Entity(repositoryClass: FEnumlibrecptaRepository::class)]
class FEnumlibrecpta
{
