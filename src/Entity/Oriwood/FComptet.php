...
use App\Repository\Oriwood\FComptetRepository;
...
class FComptet
{
    ...
    #[ORM\Column(name: "Type_Frs", length: 21, nullable: true)]
    private ?string $typeFrs = null;

    #[ORM\Column(name: "CLT_VAL", length: 69, nullable: true)]
    private ?string $cltVal = null;

    #[ORM\Column(name: "Famille_Ignorer", length: 69, nullable: true)]
    private ?string $familleIgnorer = null;
    ...
    public function getCltVal(): ?string
    {
        return $this->cltVal;
    }

    public function setCltVal(?string $cltVal): static
    {
        $this->cltVal = $cltVal;
    ...
    public function getFamilleIgnorer(): ?string
    {
        return $this->familleIgnorer;
    }

    public function setFamilleIgnorer(?string $familleIgnorer): static
    {
        $this->familleIgnorer = $familleIgnorer;
