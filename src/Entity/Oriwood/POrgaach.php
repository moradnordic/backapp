...
use App\Repository\Oriwood\POrgaachRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'P_ORGAACH')]
#[ORM\Entity(repositoryClass: POrgaachRepository::class)]
class POrgaach
{
    ...
    #[ORM\Column(name: "D_Saisie", type: Types::SMALLINT, nullable: true)]
    private ?int $dSaisie = null;

    #[ORM\Column(name: "D_Confirme", type: Types::SMALLINT, nullable: true)]
    private ?int $dConfirme = null;

    #[ORM\Column(name: "D_Defaut", type: Types::SMALLINT, nullable: true)]
    private ?int $dDefaut = null;

    #[ORM\Column(name: "D_Nombre01", type: Types::SMALLINT, nullable: true)]
    private ?int $dNombre01 = null;

    #[ORM\Column(name: "D_Nombre02", type: Types::SMALLINT, nullable: true)]
    private ?int $dNombre02 = null;

    #[ORM\Column(name: "D_Nombre03", type: Types::SMALLINT, nullable: true)]
    private ?int $dNombre03 = null;

    #[ORM\Column(name: "D_LibelleSaisie", length: 21, nullable: true)]
    private ?string $dLibellesaisie = null;

    #[ORM\Column(name: "D_LibelleConfirme", length: 21, nullable: true)]
    private ?string $dLibelleconfirme = null;

    #[ORM\Column(name: "D_LibelleValide", length: 21, nullable: true)]
    private ?string $dLibellevalide = null;
    ...
    public function getDSaisie(): ?int
    {
        return $this->dSaisie;
    }

    public function setDSaisie(?int $dSaisie): static
    {
    ...
    public function getDConfirme(): ?int
    {
        return $this->dConfirme;
    }

    public function setDConfirme(?int $dConfirme): static
    {
        $this->dConfirme = $dConfirme;

        return $this;
    }

    public function getDDefaut(): ?int
    {
        return $this->dDefaut;
    }

    public function setDDefaut(?int $dDefaut): static
    {
        $this->dDefaut = $dDefaut;

        return $this;
    }

    public function getDNombre01(): ?int
    {
        return $this->dNombre01;
    }

    public function setDNombre01(?int $dNombre01): static
    {
        $this->dNombre01 = $dNombre01;

        return $this;
    }

    public function getDNombre02(): ?int
    {
        return $this->dNombre02;
    }

    public function setDNombre02(?int $dNombre02): static
    {
        $this->dNombre02 = $dNombre02;

        return $this;
    }

    public function getDNombre03(): ?int
    {
        return $this->dNombre03;
    }

    public function setDNombre03(?int $dNombre03): static
    {
        $this->dNombre03 = $dNombre03;

        return $this;
    }

    public function getDLibellesaisie(): ?string
    {
        return $this->dLibellesaisie;
    }

    public function setDLibellesaisie(?string $dLibellesaisie): static
    {
        $this->dLibellesaisie = $dLibellesaisie;

        return $this;
    }

    public function getDLibelleconfirme(): ?string
    {
        return $this->dLibelleconfirme;
    }

    public function setDLibelleconfirme(?string $dLibelleconfirme): static
    {
        $this->dLibelleconfirme = $dLibelleconfirme;

        return $this;
    }

    public function getDLibellevalide(): ?string
    {
        return $this->dLibellevalide;
    }

    public function setDLibellevalide(?string $dLibellevalide): static
    {
        $this->dLibellevalide = $dLibellevalide;
