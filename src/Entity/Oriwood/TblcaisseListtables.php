...
use App\Repository\Oriwood\TblcaisseListtablesRepository;
...
class TblcaisseListtables
{
    ...
    #[ORM\Column(name: "CaissePrincipale")]
    private ?bool $caisseprincipale = null;
    ...
    public function getCaisseprincipale(): ?bool
    {
        return $this->caisseprincipale;
    }

    public function setCaisseprincipale(bool $caisseprincipale): static
    {
