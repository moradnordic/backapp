...
use App\Repository\Nd\NosbanquesContactpersonsRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'NosBanques_ContactPersons')]
#[ORM\Entity(repositoryClass: NosbanquesContactpersonsRepository::class)]
class NosbanquesContactpersons
{
    #[ORM\Column(name: "N°")]
    private ?int $n° = null;
