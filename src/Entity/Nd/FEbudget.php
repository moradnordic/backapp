...
use App\Repository\Nd\FEbudgetRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'F_EBUDGET')]
#[ORM\UniqueConstraint(name: 'IEB_BDNO', columns: ['cbCG_Num'])]
#[ORM\Index(name: 'IEB_CGNUM', columns: ['cbCG_Num'])]
#[ORM\Index(name: 'FKIA_F_EBUDGET_CG_Num', columns: ['CG_Num'])]
#[ORM\Index(name: 'FKIA_F_EBUDGET_BD_No', columns: ['BD_No'])]
#[ORM\Entity(repositoryClass: FEbudgetRepository::class)]
class FEbudget
{
