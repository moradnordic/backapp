...
use App\Repository\Nd\AaaSaDefDoDomaineRepository;
...
class AaaSaDefDoDomaine
{
    ...
    #[ORM\Column(name: "CoefStock", nullable: true)]
    private ?int $coefstock = null;
    ...
    public function getCoefstock(): ?int
    {
        return $this->coefstock;
    }

    public function setCoefstock(?int $coefstock): static
    {
        $this->coefstock = $coefstock;
